<header>
    <div class="flex justify-center py-7 fixed top-0 w-full z-60 transition-500 duration-500 ease-in-out" id="header">
        <div class="max-w-7xl w-full flex justify-between items-center section-container relative">
            <div>
                <a class="text-white text-xl" href="painel_de_controle.php">Painel de Controle</a>
            </div>
            ...
            <nav>
                <ul class="text-white flex gap-12">
                    <li>
                        <a class="transition-300 duration-300 hover:text-gray-200" href="../index.php">Início</a>
                    </li>
                    <li>
                        <a class="transition-300 duration-300 hover:text-gray-200" href="../sair.php">Sair</a>
                    </li>
                </ul>
            </nav>
        </div>

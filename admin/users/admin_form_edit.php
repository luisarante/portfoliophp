...
if ($id) {
    $sql = "SELECT admins_nome, admins_email FROM admins WHERE admins_id = $id";
            ...
            <form method="POST" action="user_edit.php" class="space-y-6">
                <fieldset>
                    <div class="flex justify-between w-full items-center mb-6">
                        ...
                        <a href="./" class="cursor-pointer"><i class="fa-solid fa-x text-black text-2xl"></i></a>
                    </div>
                    <input type="hidden" name="id" value="<?php echo htmlspecialchars($id); ?>">
                    <div class="flex flex-col space-y-2">
                        <label for="nomeAdmin" class="text-gray-700 font-medium">Alterar nome <span class="text-red-500">*</span></label>
                        <input
                            id="nomeAdmin"
                            name="nome"
                            type="text"
                    ...
                    <div class="flex flex-col space-y-2 mt-3">
                        <label for="emailAdmin" class="text-gray-700 font-medium">Alterar e-mail <span class="text-red-500">*</span></label>
                        <input
                            id="emailAdmin"
                            name="email"
                            type="email"
                    ...
                    <div class="flex flex-col relative space-y-2 mt-3">
                        <label for="senhaAdmin" class="text-gray-700 font-medium">Nova senha</label>
                        <div class="relative">
                            <input
                                id="senhaAdmin"
                                name="senha"
                            ...
                            <button type="button"
                                id="mostrar"
                                class="absolute cursor-pointer right-3 top-1/2 -translate-y-1/2 text-gray-500">
